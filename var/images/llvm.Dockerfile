...
RUN cmake -S=/home/target/intermediate -B=/home/target/make -DCMAKE_LIBRARY_OUTPUT_DIRECTORY=/usr/local/lib -DCMAKE_RUNTIME_OUTPUT_DIRECTORY=/usr/local/bin -DVI_VECTORCLASS=OFF $CONFIGURE
